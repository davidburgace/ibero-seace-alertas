...
app.get('/api/interes', async (_, res, next) => {
  try {
    ...
    .select('id, external_id, nomenclature, title, entity, published_date, resultado, detalle_bien, fecha_consultas, fecha_bases_admin, fecha_bases_integradas, fecha_presentacion, fecha_buena_pro, source_url, observacion')
